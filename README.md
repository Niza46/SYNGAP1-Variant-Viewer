...
4. **Run the Application**: In RStudio, click the "Run App" button. The application will start, allowing you to explore and visualize SYNGAP1 variants.
...
1. **Select Your Variants**: Use the filtering options to select specific variants of interest.
2. **View Genetic Information**: Click on a variant to see detailed information, including its impact and related research assets.
3. **Export Data**: If you need to share your findings, use the export feature to save your visualizations.
